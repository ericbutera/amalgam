...
type MutationResolver interface {
	...
	DeleteFeed(ctx context.Context, id string) (*model.Feed, error)
}
...
func (ec *executionContext) field_Mutation_deleteFeed_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Mutation_deleteFeed_argsID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["id"] = arg0
...
func (ec *executionContext) field_Mutation_deleteFeed_argsID(
	ctx context.Context,
	rawArgs map[string]interface{},
) (string, error) {
...
func (ec *executionContext) _Mutation_deleteFeed(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteFeed(rctx, fc.Args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
