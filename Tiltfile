...
go_compile('feed-fetch-worker-compile', './data-pipeline/temporal/feed_fetch/worker', ['./data-pipeline/temporal'])
...
go_compile('feed-add-worker-compile', './data-pipeline/temporal/feed_add/worker', ['./data-pipeline/temporal'])
