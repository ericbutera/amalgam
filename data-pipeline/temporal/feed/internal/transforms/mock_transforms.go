...
func (_m *MockTransforms) ArticleToJsonl(feedId string, articles parse.Articles) (io.Reader, []error) {
	...
	var r0 io.Reader
	var r1 []error
	if rf, ok := ret.Get(0).(func(string, parse.Articles) (io.Reader, []error)); ok {
		return rf(feedId, articles)
	}
	if rf, ok := ret.Get(0).(func(string, parse.Articles) io.Reader); ok {
...
func (_c *MockTransforms_ArticleToJsonl_Call) Return(_a0 io.Reader, _a1 []error) *MockTransforms_ArticleToJsonl_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTransforms_ArticleToJsonl_Call) RunAndReturn(run func(string, parse.Articles) (io.Reader, []error)) *MockTransforms_ArticleToJsonl_Call {
	_c.Call.Return(run)
	return _c
}
