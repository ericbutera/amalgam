...
var file_feeds_v1_service_proto_rawDesc = []byte{
	...
	0x22, 0x38, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x07, 0x66, 0x65, 0x65, 0x64, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xba, 0x48, 0x05, 0x72, 0x03, 0xb0,
	0x01, 0x01, 0x52, 0x06, 0x66, 0x65, 0x65, 0x64, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x14, 0x4c, 0x69,
	...
	0x73, 0x22, 0x2d, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x52,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x3a, 0x02, 0x18, 0x01, 0x32, 0xd1, 0x04, 0x0a, 0x0b, 0x46, 0x65,
	...
	,
...
var file_feeds_v1_service_proto_depIdxs = []int32{
	24, // 0: feeds.v1.Article.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 1: feeds.v1.GetFeedResponse.feed:type_name -> feeds.v1.Feed
	1,  // 2: feeds.v1.ListFeedsResponse.feeds:type_name -> feeds.v1.Feed
	22, // 3: feeds.v1.CreateFeedRequest.feed:type_name -> feeds.v1.CreateFeedRequest.Feed
	23, // 4: feeds.v1.UpdateFeedRequest.feed:type_name -> feeds.v1.UpdateFeedRequest.Feed
	2,  // 5: feeds.v1.ListArticlesResponse.articles:type_name -> feeds.v1.Article
	2,  // 6: feeds.v1.GetArticleResponse.article:type_name -> feeds.v1.Article
	2,  // 7: feeds.v1.SaveArticleRequest.article:type_name -> feeds.v1.Article
	19, // 8: feeds.v1.ValidationErrors.errors:type_name -> feeds.v1.ValidationError
	0,  // 9: feeds.v1.FeedTaskRequest.task:type_name -> feeds.v1.FeedTaskRequest.Task
	4,  // 10: feeds.v1.FeedService.GetFeed:input_type -> feeds.v1.GetFeedRequest
	6,  // 11: feeds.v1.FeedService.ListFeeds:input_type -> feeds.v1.ListFeedsRequest
	8,  // 12: feeds.v1.FeedService.CreateFeed:input_type -> feeds.v1.CreateFeedRequest
	10, // 13: feeds.v1.FeedService.UpdateFeed:input_type -> feeds.v1.UpdateFeedRequest
	12, // 14: feeds.v1.FeedService.ListArticles:input_type -> feeds.v1.ListArticlesRequest
	14, // 15: feeds.v1.FeedService.GetArticle:input_type -> feeds.v1.GetArticleRequest
	16, // 16: feeds.v1.FeedService.SaveArticle:input_type -> feeds.v1.SaveArticleRequest
	20, // 17: feeds.v1.FeedService.FeedTask:input_type -> feeds.v1.FeedTaskRequest
	5,  // 18: feeds.v1.FeedService.GetFeed:output_type -> feeds.v1.GetFeedResponse
	7,  // 19: feeds.v1.FeedService.ListFeeds:output_type -> feeds.v1.ListFeedsResponse
	9,  // 20: feeds.v1.FeedService.CreateFeed:output_type -> feeds.v1.CreateFeedResponse
	11, // 21: feeds.v1.FeedService.UpdateFeed:output_type -> feeds.v1.UpdateFeedResponse
	13, // 22: feeds.v1.FeedService.ListArticles:output_type -> feeds.v1.ListArticlesResponse
	15, // 23: feeds.v1.FeedService.GetArticle:output_type -> feeds.v1.GetArticleResponse
	17, // 24: feeds.v1.FeedService.SaveArticle:output_type -> feeds.v1.SaveArticleResponse
	21, // 25: feeds.v1.FeedService.FeedTask:output_type -> feeds.v1.FeedTaskResponse
